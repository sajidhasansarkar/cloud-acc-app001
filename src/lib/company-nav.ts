...
// "Overview" (Phase 2B-2A) and "Settings" (Phase 2B-2B-2 — General,
// Accounting, Fiscal Period, Country & Currency) are functional. Every
// other module is still a placeholder route (see section 3 of the original
// Phase 2B-2A spec) and renders as a disabled, "Soon"-badged item here,
// matching the pattern already used by the org-level sidebar in
// src/lib/nav.ts.
export const COMPANY_NAV_ITEMS: CompanyNavItem[] = [
  ...
  { label: "Chart of Accounts", segment: "chart-of-accounts", icon: ListTree, implemented: false },
